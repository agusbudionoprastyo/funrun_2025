...
<script>
    async function fetchData() {
        try {
            ...
            if (document.getElementById("pagination-table") && typeof simpleDatatables.DataTable !== 'undefined') {
                dataTableInstance = new simpleDatatables.DataTable("#pagination-table", {
                    searchable: true,
                    paging: true,
                    perPage: 10,
                ...
                setTimeout(moveSearchBoxToHeader, 100); // Move search box after DataTable renders
            }
    ...
    // After DataTable is initialized, move the search box to our custom header bar
    let dataTableInstance = null;
    function moveSearchBoxToHeader() {
        const searchBox = document.querySelector('.dataTable-search');
        const searchBoxContainer = document.getElementById('datatable-search-box');
        if (searchBox && searchBoxContainer) {
            searchBoxContainer.appendChild(searchBox);
            searchBox.classList.add('!mb-0');
        }
    }
</script>
